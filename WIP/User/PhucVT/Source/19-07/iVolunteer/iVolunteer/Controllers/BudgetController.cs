...
namespace iVolunteer.Controllers
{
    public class BudgetController : Controller
    {
        ...
        //Finance View
        public ActionResult DetailFinance(string projectID, string userRole)
        {
            try
            {
                //set new ViewBag
        ...
        public ActionResult DetailFinanceItem(string financeID, string userRole)
        {
        ...
        //Finance Add Item
        [HttpGet]
        public ActionResult AddFinanceItem(string financeID, string userRole)
        {
            ViewBag.FinanceID = financeID;
            ViewBag.UserRole = userRole;
        ...
        [HttpPost]
        public ActionResult AddFinanceItem(string financeID, string userRole, FinanceItem itemInfo, string txtPayer)
        {
            if (!ModelState.IsValid) return View();
            ...
            try
            {
                ...
                return RedirectToAction("DetailFinance", "Budget", new { projectID = projectID, userRole = userRole });
            }
            catch (Exception e)
            {
                ViewBag.Message = e.ToString();
        ...
        //Delete Finance Item
        public ActionResult DeleteFinanceItem(string financeID, string userRole, string financeItemID)
        {
            if (!ModelState.IsValid) return View();
        ...
        //Fund View
        public ActionResult DetailFund(string projectID, string userRole)
        {
            try
            {
                //set new ViewBag
        ...
        public ActionResult DetailTeamFoundDonator(string fundID, string userRole)
        {
        ...
        //AddTeamFoundDonator
        [HttpGet]
        public ActionResult AddTeamFoundDonator(string fundID, string userRole)
        {
            ViewBag.FundID = fundID;
            ViewBag.UserRole = userRole;
        ...
        [HttpPost]
        public ActionResult AddTeamFoundDonator(string fundID, string userRole, TeamFoundDonator donator)
        {
            if (!ModelState.IsValid) return View();
            ...
            try
            {
                ...
                return RedirectToAction("DetailFund", "Budget", new { projectID = projectID, userRole = userRole });
            }
            catch (Exception e)
            {
                ViewBag.Message = e.ToString();
        ...
        public ActionResult DeleteTeamFoundDonator(string fundID, string userRole, string teamFoundDonatorID)
        {
            if (!ModelState.IsValid) return View();
        ...
        [HttpGet]
        public ActionResult IsReceiceMoneyChange(string fundID, string userRole, string teamFoundDonatorID)
        {
            ViewBag.FundID = fundID;
            ViewBag.UserRole = userRole;
        ...
        [HttpPost]
        public ActionResult IsReceiceMoneyChange(string fundID, string userRole, string teamFoundDonatorID, string cbxIsReceive)
        {
            if (!ModelState.IsValid) return View();
        ...
        public ActionResult DetailOutSideDonator(string fundID, string userRole)
        {
        ...
        public ActionResult DetailInSideDonator(string fundID, string userRole)
        {
            ViewBag.FunID = fundID;
            ViewBag.UserRole = userRole;
            try
